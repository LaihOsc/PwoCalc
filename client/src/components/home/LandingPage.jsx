    ...
    <>
      ...
      <Container id='home' w={1500}>
        ...
        <Stack
          ...
          <Text color={'gray.500'}>
          In addition to comparing pre-workout supplements, Topwo also allows you to create your own personalized pre-workout blend. Our easy-to-use interface lets you select the ingredients you want in your blend, and then calculates the optimal dosages based on your personal information such as weight and goals. You can even save your customized blend for future use or share it with friends.
          </Text>
          <Text color={'gray.500'}>
          At Topwo, we believe that every athlete deserves access to the best pre-workout supplements on the market. That's why we work hard to provide you with the most comprehensive and up-to-date information available. Whether you're a beginner or an experienced athlete, we've got you covered.
          </Text>
          <Text color={'gray.500'}>
          So why wait? Start today and create your own personalized pre-workout blend or compare popular pre-workouts to find the best option for you!
          </Text>
